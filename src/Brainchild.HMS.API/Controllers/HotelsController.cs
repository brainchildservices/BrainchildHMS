...
namespace Brainchild.HMS.API.Controllers
{
    ...
    public class HotelsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Hotel>> GetRoomStatsbyMonth(int hotelId,Hotel hotel)
        {
            try
            {
                _logger.LogInformation("HotelsController.GetRoomStatsbyMonth Method is called");
